                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="page_slug" value="{{ $page->page_slug }}"
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <textarea name="page_short" class="form-control @error('page_short') is-invalid @enderror" id="page_short"
                                            cols="10" rows="3">{{ $page->page_short }}</textarea>
                                        @error('page_short')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <textarea name="page_long" class="form-control @error('page_long') is-invalid @enderror" id="page_long" cols="10"
                                            rows="5">{{ $page->page_long }}</textarea>
                                        @error('page_long')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror"
                                            id="meta_description" cols="10" rows="3">{{ $page->meta_description }}</textarea>
