            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted float-end">
                        <a href="{{ route('module.index') }}" class="btn btn-secondary"><i class="bx bx-arrow-back"></i> Back
                            to Module</a></small>
                </div>
                <div class="card-body">
                    <form action="{{ route('module.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="module_name" class="form-control" id="basic-default-fullname"
